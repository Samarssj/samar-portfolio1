...
const projects: Project[] = [
  {
    ...
    description: 'Enterprise conversational AI platform for customer support automation, intent recognition, knowledge retrieval, multi-turn conversations, and escalations using Vertex AI and Dialogflow CX.',
    metrics: [
