  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="p-6 rounded-lg border border-accent/20 bg-background/50 shadow-[0_0_15px_rgba(34,197,94,0.08)] md:shadow-none md:border-border hover:scale-[1.01] md:hover:border-accent md:hover:shadow-[0_0_20px_#22c55e] transition-all duration-300 cursor-pointer">
          <div className="mb-6">
